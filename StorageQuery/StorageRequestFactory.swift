...
public struct StorageQueryListOptions {
    public let atBlock: Data?
    public let ignoresFailedItems: Bool

    public init(atBlock: Data? = nil, ignoresFailedItems: Bool = false) {
...
enum StorageRequestFactoryError: Error {
    case noResponse
}
        ...
        do {
            ...
            let mappingOperation = ClosureOperation<StorageResponse<T>> {
                ...
                guard let response = responses.first else {
                    throw StorageRequestFactoryError.noResponse
                }
