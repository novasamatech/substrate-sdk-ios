...
Pod::Spec.new do |s|
  ...
  s.dependency 'NovaCrypto/sr25519', '~> 0.2.0'
  s.dependency 'NovaCrypto/ed25519', '~> 0.2.0'
  s.dependency 'NovaCrypto/secp256k1', '~> 0.2.0'
  s.dependency 'NovaCrypto/Scrypt', '~> 0.2.0'
  s.dependency 'NovaCrypto/ss58', '~> 0.2.0'
