...
public protocol SignatureCreatorProtocol: AnyObject {
    func sign(_ originalData: Data, context: SigningContext) throws -> IRSignatureProtocol
}

public protocol SigningWrapperProtocol: SignatureCreatorProtocol {}

public extension SigningWrapperProtocol {
