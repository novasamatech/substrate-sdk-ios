...
class IconGenerationTests: XCTestCase {
    func testIconGeneration() throws {
        ...
        let iconGenerator = KusamaIconGenerator()

        let expectedCircles: [KusamaIcon.Circle] = [
                                        KusamaIcon.Circle(origin: CGPoint(x: 32.0, y: 8.0),
                                                          color: UIColor.colorWithHSL(hue: 196, saturation: 0.65, lightness: 0.53),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 32.0, y: 20.0),
                                                          color: UIColor.colorWithHSL(hue: 320, saturation: 0.65, lightness: 0.53),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 21.607695154586736, y: 14.0),
                                                          color: UIColor(white: 1.0, alpha: 0.0),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 11.215390309173472, y: 20.0),
                                                          color: UIColor.colorWithHSL(hue: 112, saturation: 0.65, lightness: 0.15),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 21.607695154586736, y: 26.0),
                                                          color: UIColor.colorWithHSL(hue: 22, saturation: 0.65, lightness: 0.15),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 11.215390309173472, y: 32.0),
                                                          color: UIColor.colorWithHSL(hue: 213, saturation: 0.65, lightness: 0.15),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 11.215390309173472, y: 44.0),
                                                          color: UIColor.colorWithHSL(hue: 163, saturation: 0.65, lightness: 0.53),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 21.607695154586736, y: 38.0),
                                                          color: UIColor.colorWithHSL(hue: 213, saturation: 0.65, lightness: 0.53),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 21.607695154586736, y: 50.0),
                                                          color: UIColor.colorWithHSL(hue: 185, saturation: 0.65, lightness: 0.75),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 32.0, y: 56.0),
                                                          color: UIColor.colorWithHSL(hue: 163, saturation: 0.65, lightness: 0.53),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 32.0, y: 44.0),
                                                          color: UIColor.colorWithHSL(hue: 213, saturation: 0.65, lightness: 0.53),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 42.392304845413264, y: 50.0),
                                                          color: UIColor.colorWithHSL(hue: 213, saturation: 0.65, lightness: 0.15),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 52.78460969082653, y: 44.0),
                                                          color: UIColor.colorWithHSL(hue: 112, saturation: 0.65, lightness: 0.15),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 42.392304845413264, y: 38.0),
                                                          color: UIColor.colorWithHSL(hue: 22, saturation: 0.65, lightness: 0.15),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 52.78460969082653, y: 32.0),
                                                          color: UIColor(white: 1.0, alpha: 0.0),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 52.78460969082653, y: 20.0),
                                                          color: UIColor.colorWithHSL(hue: 196.0, saturation: 0.65, lightness: 0.53),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 42.392304845413264, y: 26.0),
                                                          color: UIColor.colorWithHSL(hue: 320.0, saturation: 0.65, lightness: 0.53),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 42.392304845413264, y: 14.0),
                                                          color: UIColor.colorWithHSL(hue: 11.0, saturation: 0.65, lightness: 0.35),
                                                          radius: 5),
                                        KusamaIcon.Circle(origin: CGPoint(x: 32, y: 32),
                ...
                return KusamaIcon.Circle(origin: center,
                                         color: circle.color,
        ...
        let icon = try iconGenerator.generateFromAddress(address) as! KusamaIcon
    ...
    func testOutOfBoundsColorParameters() {
        ...
        XCTAssertNoThrow(try KusamaIconGenerator().generateFromAddress(address))
    }
}
