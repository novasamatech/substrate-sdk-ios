...
class ExtrinsicExtensionsTests: XCTestCase {
    func testChargeAssetExtension() throws {
        ...
        let extrinsicExtension = ChargeAssetTxPayment()
        let extensionCoder = DefaultExtrinsicExtensionCoder(
            name: type(of: extrinsicExtension).name,
        ...
        builder = builder.adding(extrinsicExtension: extrinsicExtension)
